...
def execute_cmdline(argv):
    ...
    p = add_command(    'create_from_images_labels', 'Create dataset from a directory full of images and labels.',
                                            'create_from_images_labels datasets/mydataset myimagedir')
    p.add_argument(     'tfrecord_dir',     help='New dataset directory to be created')
    p.add_argument(     'image_dir',        help='Directory containing the images')
    p.add_argument(     'label_dir',        help='Directory containing the labels')
    p.add_argument(     'label_file',       help='File containing the labels')
    p.add_argument(     '--shuffle',        help='Randomize image order (default: 1)', type=int, default=1)
