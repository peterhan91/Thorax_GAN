...
data_dir = '/media/tianyu.han/mri-scratch/DeepLearning/dataset/'
result_dir = '/media/tianyu.han/mri-scratch/DeepLearning/CheXpert_Dataset/GAN_CheXpert/'
...
random_seed = 1888                                          # Global random seed.
