...
def args_parser():
    ...
    parser.add_argument('--sample', type=int, default=20000, help="number of total images")
    ...
    # other arguments
    parser.add_argument('--dataset', type=str, default='cxr', help="name of dataset")
    parser.add_argument('--pf_path', type=str, default='./label/cheXPert_label.csv', help=".csv file path")
    parser.add_argument('--path_to_folder', type=str, default='../CheXpert_Dataset/images_256/images/', help="image path")
    parser.add_argument('--iid', type=bool, default=False, help='whether i.i.d or not')
    parser.add_argument('--OUTPUT_PATH', type=str, default='./runs_/', help='save path')
